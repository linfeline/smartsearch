...
- `smart-search doubao-search QUERY [--count N] [--time-range VALUE] [--sites HOSTS] [--auth-level 0|1] [--no-content] [--format json|markdown|content] [--output PATH]`
